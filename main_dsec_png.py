...
parser.add_argument('--datapath', default='/disk2/users/M22_zhaoqinghao/Dataset/png',
                    help='datapath')
parser.add_argument('--trainlist', default='"/disk2/users/M22_zhaoqinghao/Dataset/png/train_uint16.txt"', 
                    help='training list')
parser.add_argument('--testlist', default='"/disk2/users/M22_zhaoqinghao/Dataset/png/test_uint16.txt"', 
                    help='testing list')
...
parser.add_argument('--logdir',default='./logs_png/', help='the directory to save logs and checkpoints')
